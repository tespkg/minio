...
import (
	...
	"github.com/minio/minio/pkg/coreos/etcd/client"
	"github.com/minio/minio/pkg/coreos/etcd/clientv3"
	"github.com/minio/minio/pkg/coreos/etcd/embed"
	"github.com/minio/minio/pkg/coreos/etcd/etcdserver"
	"github.com/minio/minio/pkg/coreos/etcd/etcdserver/api/etcdhttp"
	"github.com/minio/minio/pkg/coreos/etcd/etcdserver/api/v2http"
	"github.com/minio/minio/pkg/coreos/etcd/etcdserver/api/v3client"
	"github.com/minio/minio/pkg/coreos/etcd/etcdserver/api/v3election"
	epb "github.com/minio/minio/pkg/coreos/etcd/etcdserver/api/v3election/v3electionpb"
	"github.com/minio/minio/pkg/coreos/etcd/etcdserver/api/v3lock"
	lockpb "github.com/minio/minio/pkg/coreos/etcd/etcdserver/api/v3lock/v3lockpb"
	"github.com/minio/minio/pkg/coreos/etcd/etcdserver/api/v3rpc"
	pb "github.com/minio/minio/pkg/coreos/etcd/etcdserver/etcdserverpb"
	"github.com/minio/minio/pkg/coreos/etcd/pkg/testutil"
	"github.com/minio/minio/pkg/coreos/etcd/pkg/tlsutil"
	"github.com/minio/minio/pkg/coreos/etcd/pkg/transport"
	...
	"github.com/minio/minio/pkg/grpc/keepalive"
...
var (
	...
	plog = capnslog.NewPackageLogger("github.com/minio/minio/pkg/coreos/etcd", "integration")
)
