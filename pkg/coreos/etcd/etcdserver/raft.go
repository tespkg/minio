...
import (
	...
	"github.com/minio/minio/pkg/coreos/etcd/pkg/contention"
	...
	"github.com/minio/minio/pkg/coreos/etcd/wal/walpb"
)
...
func init() {
	raft.SetLogger(capnslog.NewPackageLogger("github.com/minio/minio/pkg/coreos/etcd", "raft"))
