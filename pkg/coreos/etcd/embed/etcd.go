...
import (
	...
	"github.com/minio/minio/pkg/coreos/etcd/pkg/cors"
	"github.com/minio/minio/pkg/coreos/etcd/pkg/debugutil"
	runtimeutil "github.com/minio/minio/pkg/coreos/etcd/pkg/runtime"
...
var plog = capnslog.NewPackageLogger("github.com/minio/minio/pkg/coreos/etcd", "embed")
...
func stopServers(ctx context.Context, ss *servers) {
	...
	// and https://github.com/minio/minio/pkg/coreos/etcd/issues/8916
	if ss.secure {
		shutdownNow()
		return
	}
