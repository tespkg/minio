...
import (
	...
	"github.com/minio/minio/pkg/coreos/etcd/pkg/netutil"
	"github.com/minio/minio/pkg/coreos/etcd/pkg/srv"
...
type Config struct {
	...
	//
	// See https://github.com/minio/minio/pkg/coreos/etcd/issues/9333 for more detail.
...
func (cfg *Config) SetupLogging() {
	...
	if cfg.LogPkgLevels != "" {
		repoLog := capnslog.MustRepoLogger("github.com/minio/minio/pkg/coreos/etcd")
