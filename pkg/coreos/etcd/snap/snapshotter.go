...
import (
	...
	pioutil "github.com/minio/minio/pkg/coreos/etcd/pkg/ioutil"
	...
	"github.com/minio/minio/pkg/coreos/etcd/snap/snappb"
...
var (
	plog = capnslog.NewPackageLogger("github.com/minio/minio/pkg/coreos/etcd", "snap")
