...
import (
	_ "github.com/minio/minio/pkg/grpc/xds/internal/balancer" // Register the balancers.
	_ "github.com/minio/minio/pkg/grpc/xds/internal/resolver" // Register the xds_resolver
)
