...
func (l *ossObjects) StorageInfo(ctx context.Context, _ bool) (si minio.StorageInfo, _[]error) {
...
func (l *ossObjects) MakeBucketWithLocation(ctx context.Context, bucket, location string, lockEnabled bool) error {
    if lockEnabled {
